...
type LowRatedMoviesScreenNavigationProp = StackNavigationProp<RootStackParamList, 'LowRatedMovies'>;

interface LowRatedMoviesScreenProps {
    navigation: LowRatedMoviesScreenNavigationProp;
}

export const LowRatedMoviesScreen: React.FC<LowRatedMoviesScreenProps> = ({ navigation }) => {
    ...
    const fetchLowRatedMovies = async () => {
        try {
            setLoading(true);
            ...
            console.error(error);
            setError('Failed to load lowest rated movies');
        } finally {
            setLoading(false);
        }
    };
    ...
    const renderHeader = () => (
        <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Low Rated Movies</Text>
