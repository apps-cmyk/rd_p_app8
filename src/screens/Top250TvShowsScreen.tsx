...
type Top250TvShowsScreenNavigationProp = StackNavigationProp<RootStackParamList, 'Top250TvShows'>;

interface Top250TvShowsScreenProps {
    navigation: Top250TvShowsScreenNavigationProp;
}

export const Top250TvShowsScreen: React.FC<Top250TvShowsScreenProps> = ({ navigation }) => {
    ...
    const renderHeader = () => (
        <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Top 250 TV Shows</Text>
