...
type TopRatedMoviesScreenNavigationProp = StackNavigationProp<RootStackParamList, 'TopRatedMovies'>;

interface TopRatedMoviesScreenProps {
    navigation: TopRatedMoviesScreenNavigationProp;
}

export const TopRatedMoviesScreen: React.FC<TopRatedMoviesScreenProps> = ({ navigation }) => {
